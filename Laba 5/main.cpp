...
int main() {
    ...
    string start_street_query = "Via Cristoforo Colombo";      // Название улицы для старта (пример)
    string end_street_query = "Via Ardeatina";      // Название улицы для финиша (пример)
